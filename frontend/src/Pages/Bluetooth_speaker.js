...
function BluetoothSpeaker() {
  ...
  const category = "Bluetooth_Speaker";
  ...
  const filteredData = speakerData.filter((item) => item.price <= sliderValue);
  ...
  return (
    <div className="product-page">
      <div className="product-header">
        <Container>
          <h1 className="product-title">Bluetooth Speakers</h1>
          <p className="product-subtitle">Enjoy crystal clear audio with our premium wireless speakers</p>
        </Container>
      </div>
        ...
        <div className="product-grid">
          ...
          {filteredData.length === 0 ? (
            <div className="no-products">
              ...
              <p>We couldn't find any bluetooth speakers matching your filter criteria. Try adjusting your filters.</p>
            </div>
          ) : (
            <Row className="g-4">
